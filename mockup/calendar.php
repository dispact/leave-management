	...
	<body class="h-screen flex overflow-hidden bg-gray-100" x-data="data()">
			...
			>
				...
				<div class="flex-1 h-0 pt-5 pb-4 overflow-y-auto">
					...
					<nav class="mt-5 px-2 space-y-1">
						...
						<a href="/calendar.php" class="bg-gray-100 text-gray-900 group flex items-center px-2 py-2 text-base font-medium rounded-md">
					...
					<div class="flex-1 flex flex-col min-h-0 border-r border-gray-200 bg-white">
						<div class="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
							...
							<nav class="mt-5 flex-1 px-2 bg-white space-y-1">
								...
								<a href="/calendar.php" class="bg-gray-100 text-gray-900 group flex items-center px-2 py-2 text-sm font-medium rounded-md">
									<!-- Heroicon name: outline/calendar -->
		...
		<div class="flex flex-col w-0 flex-1 overflow-hidden">
			...
			<main class="flex-1 relative z-0 overflow-y-auto focus:outline-none">
				<div class="py-2">
					<div class="max-w-6xl mx-auto px-4 sm:px-4 md:px-2">
