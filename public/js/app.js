...
alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].store('collapsedSidebar', {
  init: function init() {
    var _JSON$parse;

    this.on = (_JSON$parse = JSON.parse(sessionStorage.getItem('collapsedSidebar'))) !== null && _JSON$parse !== void 0 ? _JSON$parse : false;
  },
  on: false,
